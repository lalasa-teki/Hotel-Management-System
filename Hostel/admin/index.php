...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/cutmap.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h2 class="text-center text-bold text-light mt-4x">Centurion Hostel Management System</h2>
